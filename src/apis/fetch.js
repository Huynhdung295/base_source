...
const fetchJSON = (pathToResource, params) =>
  fetch(`${URL_API}/${pathToResource}?${stringify(params)}`, { headers: getAuthHeader() })
...
const deleteRequest = (pathToResource) =>
  fetch(pathToResource, {
    method: "DELETE",
    headers: getAuthHeader(),
  })
...
export { fetchJSON, postImportJSON, deleteRequest, putJSON, postJSON };
